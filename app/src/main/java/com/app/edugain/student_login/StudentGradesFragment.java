...
import com.app.edugain.viewholders.StudentGradesViewHolder;
...
public class StudentGradesFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<String, StudentGradesViewHolder> adapter = new FirebaseRecyclerAdapter<String, StudentGradesViewHolder>
                (String.class, R.layout.student_grades_list_item, StudentGradesViewHolder.class, database.child("student_grades").child(current_user)){
